...
readonly TALENTAI_VERSION="${1:-3.1.0-rc.1}"
...
readonly TALENTAI_TAI05_SOURCE="$TALENTAI_ROOT/workflows/phase-4-5/TAI-05-secure-interview-invitation-v1.json"
...
if jq -e \
  ...
  echo 'A Phase 4/5 workflow collides with the Phase 3 package.' >&2
  exit 1
fi
