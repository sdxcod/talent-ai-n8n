...
required_operational_files=(
  ...
  "$TALENTAI_REPOSITORY_ROOT/workflows/phase-4-5/TAI-05-secure-interview-invitation-v1.json"
  "$TALENTAI_REPOSITORY_ROOT/workflows/phase-4-5/sql/load-completed-phase3-handoff-by-correlation.sql"
