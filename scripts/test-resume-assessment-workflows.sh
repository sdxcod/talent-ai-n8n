...
assert_embedded_code \
  "$TALENTAI_TAI01" \
  'Validate Assessment Intake' \
  'workflows/resume-assessment/code/tai01-validate-assessment-intake.js'

assert_embedded_code \
  "$TALENTAI_TAI01" \
  'Build Assessment Claim' \
  'workflows/resume-assessment/code/tai01-build-assessment-claim.js'

assert_embedded_code \
  "$TALENTAI_TAI01" \
  'Prepare Grading Request' \
  'workflows/resume-assessment/code/tai01-prepare-grading-request.js'

assert_embedded_code \
  "$TALENTAI_TAI01" \
  'Build Replayed Assessment Result' \
  'workflows/resume-assessment/code/tai01-build-replayed-assessment-result.js'
...
assert_embedded_code \
  "$TALENTAI_TAI01" \
  'Build Failed Assessment Result' \
  'workflows/resume-assessment/code/tai01-build-failed-assessment-result.js'

assert_embedded_code \
  "$TALENTAI_TAI01" \
  'Build Failure Recording Fallback' \
  'workflows/resume-assessment/code/tai01-build-failure-recording-fallback.js'

assert_embedded_code \
  "$TALENTAI_TAI01" \
  'Build Unrecorded Failure Result' \
  'workflows/resume-assessment/code/tai01-build-unrecorded-failure-result.js'

assert_embedded_code \
  "$TALENTAI_TAI01" \
  'Build Rejected Assessment Result' \
  'workflows/resume-assessment/code/tai01-build-rejected-assessment-result.js'

assert_embedded_code \
  "$TALENTAI_TAI02" \
  'Validate Operational Input' \
  'workflows/resume-assessment/code/tai02-validate-operational-input.js'

assert_embedded_code \
  "$TALENTAI_TAI03" \
  'Validate Grade Engine Input' \
  'workflows/resume-assessment/code/tai03-validate-operational-input.js'

assert_embedded_code \
  "$TALENTAI_TAI03" \
  'Build Grade Assessment Result' \
  'workflows/resume-assessment/code/tai03-build-assessment-result.js'

for code_file in workflows/resume-assessment/code/*.js; do
  node -e '
...
echo 'TalentAI resume assessment workflow contract passed.'
